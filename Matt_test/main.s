...
drawSprite:
	...
	mov	r1, lr
	cmp	r6, #4
	mov	r4, r0, asl #5	@  spritenumb
	add	lr, lr, #4
	mov	r0, r0, asl #3	@  spritenumb
	orr	r2, r2, #16384	@  x
	add	r3, r3, #4
	add	r1, r1, #2
	strlsh	r0, [ip, r3]	@ movhi 
	strhih	r4, [ip, lr]	@ movhi 
	strlsh	r2, [ip, r1]	@ movhi 
.L1:
...
Handler:
	...
	mov	r2, #120
	mov	r3, #80
	mov	r4, ip, asr r0	@  Flag
	bne	.L55
.L53:
	mov	r3, #1	@ movhi
	strh	r4, [r5, #0]	@ movhi 	@  Flag
	strh	r3, [r6, #0]	@ movhi 
